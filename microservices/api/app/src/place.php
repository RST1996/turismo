  ...
  <head>
    ...
    <script>
      ...
      function initMap() {
		...
		var types = ['museum','park','city_hall','aquarium','amusement_park','art_gallery','zoo']
	  ...
	  function getaccomo()
	  {
		  window.location = "accomodatio.php?place=<?php echo $_GET['place']?>&lat=<?php echo $_GET['lat']?>&lng=<?php echo $_GET['lng']?>";
	  }
    </script>
  </head>
  <body>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a onclick="getaccomo()">Accomodation</a></li>
